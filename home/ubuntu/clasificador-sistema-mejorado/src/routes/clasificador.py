        ...
        with current_app.app_context():
            ...
            for index, row in df.iterrows():
                ...
                hecho = HechoDelictivo(
                    ...
                    ipp=str(row.get('ipp', '')),
                    relato=texto_relato,
                    jurisdiccion=clasificacion.get('JURISDICCION', 'OTROS'),
                    calificacion=clasificacion.get('CALIFICACION', 'OTROS'),
                    modalidad=clasificacion.get('MODALIDAD', 'OTROS'),
                    victimas=clasificacion.get('VICTIMAS', 'OTROS'),
                    lesionado=clasificacion.get('LESIONADO', 'NO'),
                    imputados=clasificacion.get('IMPUTADOS', 'OTROS'),
                    edad=clasificacion.get('EDAD', 'OTROS'),
                    armas=clasificacion.get('ARMAS', 'NINGUNA'),
                    lugar=clasificacion.get('LUGAR', 'OTROS'),
                    tentativa=clasificacion.get('TENTATIVA', 'NO'),
